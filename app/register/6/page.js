...
import RegisterCompany from '@/app/components/RegisterCompany/RegisterCompany'
import { RegisterCompanyProvider } from '@/app/components/RegisterCompany/RegisterCompanyContext'
      ...
      <div className="w-[100vw] h-screen bg-[#1F1223] absolute top-0 left-0">
        <div className='w-[70vw] h-[80vh] bg-[#150B17] absolute top-[10vh] left-[15vw] rounded-[42px] drop-shadow-xl'>
          <div className='flex flex-col w-[60%] items-center h-[95%] ml-[20%]'>
              <h1 className='underline text-4xl mt-[5%]'>Register Your Company</h1>
